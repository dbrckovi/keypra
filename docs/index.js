...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/font.ttf", "start": 0, "end": 343140}], "remote_package_size": 343140});

  })();

// end include: /tmp/tmpti4npq1u.js
// include: /tmp/tmpe383jv5z.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpe383jv5z.js
// include: /tmp/tmp9n7vls5o.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp9n7vls5o.js
...
var ASM_CONSTS = {
  136176: () => { if (document.fullscreenElement) return 1; },  
 136222: () => { return document.getElementById('canvas').width; },  
 136274: () => { return parseInt(document.getElementById('canvas').style.width); },  
 136342: () => { document.exitFullscreen(); },  
 136369: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 136442: () => { if (document.fullscreenElement) return 1; },  
 136488: () => { return document.getElementById('canvas').width; },  
 136540: () => { return screen.width; },  
 136565: () => { document.exitFullscreen(); },  
 136592: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 136725: () => { return window.innerWidth; },  
 136751: () => { return window.innerHeight; },  
 136778: () => { if (document.fullscreenElement) return 1; },  
 136824: () => { return document.getElementById('canvas').width; },  
 136876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 136944: () => { if (document.fullscreenElement) return 1; },  
 136990: () => { return document.getElementById('canvas').width; },  
 137042: () => { return screen.width; },  
 137067: () => { return window.innerWidth; },  
 137093: () => { return window.innerHeight; },  
 137120: () => { if (document.fullscreenElement) return 1; },  
 137166: () => { return document.getElementById('canvas').width; },  
 137218: () => { return screen.width; },  
 137243: () => { document.exitFullscreen(); },  
 137270: () => { if (document.fullscreenElement) return 1; },  
 137316: () => { return document.getElementById('canvas').width; },  
 137368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 137436: () => { document.exitFullscreen(); },  
 137463: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 137521: () => { return screen.width; },  
 137546: () => { return screen.height; },  
 137572: () => { return window.screenX; },  
 137599: () => { return window.screenY; },  
 137626: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 137679: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 137750: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 137807: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 138063: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 138134: () => { if (document.fullscreenElement) return 1; },  
 138180: () => { return window.innerWidth; },  
 138206: () => { return window.innerHeight; },  
 138233: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
